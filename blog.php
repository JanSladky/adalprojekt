...
<?php
$data = $database->insert('posts', 'text');

?>

<?php foreach ($data as $item) {
    echo '<p class="justify">' . $item . '</p>';
} ?>

<main>
    <div class="container">
        <div class="main-content">
            <h1>ŽATEC A UNESCO</h1>
            <p><b>přidáno: 28.10.2019</b></p>
            <p class="justify">Je naše město hodno zápisu na seznam světového dědictví?</p>

            <button class="readmore-blog1-btn" onclick="if ($('.readmore-blog1-btn').text() == 'více') {$('.readmore-blog1-btn').text('méně'); $('.readmore-blog1').slideDown(); }else {$('.readmore-blog1-btn').text('více'); $('.readmore-blog1').slideUp();}">více</button> <br>
            ...
            <button class="readmore-blog2-btn" onclick="if ($('.readmore-blog2-btn').text() == 'více') {$('.readmore-blog2-btn').text('méně'); $('.readmore-blog2').slideDown(); }else {$('.readmore-blog2-btn').text('více'); $('.readmore-blog2').slideUp();}">více</button> <br>
